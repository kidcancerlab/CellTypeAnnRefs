...
```{r}
comb <- kill_cc(comb)
cc <- rDimPlot(comb, "All Cells - Cell Cycle Prediction")
```
...
fplots <- lapply(feats, function(f) {
...
tplot <- rDimPlot(comb, "Isolated (likely) tumor cells")
```
